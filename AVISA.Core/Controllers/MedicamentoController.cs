...
namespace AVISA.Core.Controllers
{
    public class MedicamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Quantidade,Horario")] Medicamento medicamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Quantidade,Horario")] Medicamento medicamento)
        {
